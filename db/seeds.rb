ApplicationRecord.transaction do
  ...
  Food.create(id: 2, name: '辛ラーメン キムチ 袋麺', spice_level: '1', price: '212', title: 'しゃきしゃきの白菜キムチのコクと旨みがたっぷり入った、マイルドな辛さの「辛ラーメン」。', body: 'スープと相性がよく、滑らかな口当たりとしなやかなコシをあわせ持った麺、キムチは農心独自の冷凍乾燥(フリーズドライ)製法により、しゃきしゃきした白菜キムチそのものの歯ごたえと味わい。「辛ラーメン」の旨みはそのままに日本人向けに辛みと酸味を抑えた、キムチのさっぱりとした味わいが楽しめます。', food_category_id: 1, food_country_id: 1, food_image: File.open(Rails.root.join('db/seeds/ramen_image.png')))
  Food.create(id: 3, name: '辛ラーメン ブラック 袋麺', spice_level: '2', price: '262', title: '“特製辛味スープ”と“特製豚骨スープ”のW(ダブル)スープで、コクのあるマイルドな「辛ラーメン」。', body: '濃厚でコクのある“特製豚骨スープ”と厳選した唐辛子にオリジナルスパイスを加えた、“特製辛味スープ”のWスープが味わい深いプレミアムな「辛ラーメン」です。大きめの具材(チンゲンサイ、しいたけ、味付かまぼこ、唐辛子)がスープにさらなる旨味を加えます。もちもち食感の中太麺に濃厚で程よく辛いスープがよく合います。', food_category_id: 1, food_country_id: 1, food_image: File.open(Rails.root.join('db/seeds/ramen_image.png')))
